...
export default function CTAButton({
  ...
  // Base styles
  const baseStyles = 'relative inline-flex items-center justify-center font-medium rounded-full transition-all duration-300 ease-in-out';
  ...
  return (
    <div className="relative inline-block">
      {withSparkle && isHovered && (
        <div className="absolute -top-12 -right-12 z-0 opacity-70 scale-75">
          <SparkleEffect />
        </div>
      )}
