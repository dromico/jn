...
export default function SparkleEffect() {
  ...
  return (
    ...
    >
      ...
      <circle className="sparkle" cx="45" cy="45" r="2" fill="#FFFFFF" />
      <circle className="sparkle" cx="75" cy="45" r="2" fill="#FFFFFF" />
      <circle className="sparkle" cx="45" cy="75" r="2" fill="#FFFFFF" />
      <circle className="sparkle" cx="75" cy="75" r="2" fill="#FFFFFF" />
      <circle className="sparkle" cx="60" cy="60" r="3" fill="#FFFFFF" />
    </svg>
  );
}